 ...
 */
final class Version20200710133655 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE effect_origin (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL)');
        ...
        $this->addSql('CREATE TABLE effect (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB NOT NULL COLLATE BINARY, icon CLOB NOT NULL COLLATE BINARY, CONSTRAINT FK_B66091F2C54C8C93 FOREIGN KEY (type_id) REFERENCES effect_origin (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE effect_type (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('DROP TABLE effect_origin');
        $this->addSql('DROP INDEX IDX_AD6CAEA7E48FD905');
        $this->addSql('CREATE TEMPORARY TABLE __temp__dlc AS SELECT id, game_id, name, description FROM dlc');
        $this->addSql('DROP TABLE dlc');
