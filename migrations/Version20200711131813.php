 ...
 */
final class Version20200711131813 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_B66091F256A273CC');
        $this->addSql('CREATE TEMPORARY TABLE __temp__effect AS SELECT id, origin_id, name, description, icon FROM effect');
        $this->addSql('DROP TABLE effect');
        $this->addSql('CREATE TABLE effect (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, origin_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, description CLOB NOT NULL COLLATE BINARY, icon CLOB NOT NULL COLLATE BINARY, CONSTRAINT FK_B66091F256A273CC FOREIGN KEY (origin_id) REFERENCES effect_origin (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO effect (id, origin_id, name, description, icon) SELECT id, origin_id, name, description, icon FROM __temp__effect');
        $this->addSql('DROP TABLE __temp__effect');
        $this->addSql('CREATE INDEX IDX_B66091F256A273CC ON effect (origin_id)');
        ...
        $this->addSql('CREATE TABLE lord (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, dlc_id INTEGER NOT NULL, race_id INTEGER NOT NULL, game_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, portrait CLOB NOT NULL COLLATE BINARY, faction VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_44E9A58FCEF6326C FOREIGN KEY (dlc_id) REFERENCES dlc (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_44E9A58F6E59D40D FOREIGN KEY (race_id) REFERENCES race (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_44E9A58FE48FD905 FOREIGN KEY (game_id) REFERENCES game (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE INDEX IDX_44E9A58FE48FD905 ON lord (game_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__race AS SELECT id, dlc_id, name FROM race');
        ...
        $this->addSql('INSERT INTO race (id, dlc_id, name) SELECT id, dlc_id, name FROM __temp__race');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__effect AS SELECT id, origin_id, name, description, icon FROM effect');
        $this->addSql('DROP TABLE effect');
        $this->addSql('CREATE TABLE effect (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, origin_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, description CLOB NOT NULL, icon CLOB NOT NULL)');
        $this->addSql('INSERT INTO effect (id, origin_id, name, description, icon) SELECT id, origin_id, name, description, icon FROM __temp__effect');
        $this->addSql('DROP TABLE __temp__effect');
        $this->addSql('CREATE INDEX IDX_B66091F256A273CC ON effect (origin_id)');
        $this->addSql('DROP INDEX IDX_44E9A58FCEF6326C');
        $this->addSql('DROP INDEX IDX_44E9A58F6E59D40D');
        $this->addSql('DROP INDEX IDX_44E9A58FE48FD905');
        $this->addSql('CREATE TEMPORARY TABLE __temp__lord AS SELECT id, dlc_id, race_id, name, portrait, faction FROM lord');
        $this->addSql('DROP TABLE lord');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__race AS SELECT id, dlc_id, name FROM race');
        $this->addSql('DROP TABLE race');
        $this->addSql('CREATE TABLE race (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, dlc_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO race (id, dlc_id, name) SELECT id, dlc_id, name FROM __temp__race');
        $this->addSql('DROP TABLE __temp__race');
        $this->addSql('CREATE INDEX IDX_DA6FBBAFCEF6326C ON race (dlc_id)');
        $this->addSql('DROP INDEX IDX_81C61C1C6E59D40D');
