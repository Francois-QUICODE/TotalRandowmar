 ...
 */
final class Version20200710154256 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO effect (id, origin_id, name, description, icon) SELECT id, type_id, name, description, icon FROM __temp__effect');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE effect');
        $this->addSql('CREATE TABLE effect (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description CLOB NOT NULL, icon CLOB NOT NULL, type_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO effect (id, type_id, name, description, icon) SELECT id, origin_id, name, description, icon FROM __temp__effect');
        $this->addSql('DROP TABLE __temp__effect');
