 ...
 */
final class Version20200708145902 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__lord AS SELECT id, dlc_id, race_id, name, portrait FROM lord');
        $this->addSql('DROP TABLE lord');
        $this->addSql('CREATE TABLE lord (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, dlc_id INTEGER NOT NULL, race_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, portrait CLOB NOT NULL COLLATE BINARY, faction VARCHAR(255) NOT NULL, CONSTRAINT FK_44E9A58FCEF6326C FOREIGN KEY (dlc_id) REFERENCES dlc (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_44E9A58F6E59D40D FOREIGN KEY (race_id) REFERENCES race (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO lord (id, dlc_id, race_id, name, portrait) SELECT id, dlc_id, race_id, name, portrait FROM __temp__lord');
