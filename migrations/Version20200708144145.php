 ...
 */
final class Version20200708144145 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE lord (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, dlc_id INTEGER NOT NULL, race_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, portrait CLOB NOT NULL COLLATE BINARY, CONSTRAINT FK_44E9A58FCEF6326C FOREIGN KEY (dlc_id) REFERENCES dlc (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_44E9A58F6E59D40D FOREIGN KEY (race_id) REFERENCES race (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
